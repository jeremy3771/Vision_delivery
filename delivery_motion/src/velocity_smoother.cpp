...
VelocitySmoother::VelocitySmoother() : Node("velocity_smoother") {
  declare_parameter("smoothing_frequency", rclcpp::ParameterValue(20.0));
  declare_parameter("max_velocity", rclcpp::ParameterValue(std::vector<double>{0.50, 0.0, 2.5}));
  declare_parameter("min_velocity", rclcpp::ParameterValue(std::vector<double>{-0.50, 0.0, -2.5}));
  declare_parameter("max_accel", rclcpp::ParameterValue(std::vector<double>{2.5, 0.0, 3.2}));
  declare_parameter("max_decel", rclcpp::ParameterValue(std::vector<double>{-2.5, 0.0, -3.2}));
  declare_parameter("deadband_velocity", rclcpp::ParameterValue(std::vector<double>{0.0, 0.0, 0.0}));
  declare_parameter("velocity_timeout", rclcpp::ParameterValue(1.0));
  ...
  get_parameter("velocity_timeout", velocity_timeout_);
