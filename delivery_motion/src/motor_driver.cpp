...
bool MotorCommand::writeYawPosition(const int64_t value[4]) {
...
bool MotorCommand::writeGimbalPosition(const int64_t value[4]) {
    bool dxl_addparam_result;
    int8_t dxl_comm_result;
    uint8_t data_byte[4] = {0, };
    ...
    data_byte[2] = DXL_LOBYTE(DXL_HIWORD(value[0]));
    data_byte[3] = DXL_HIBYTE(DXL_HIWORD(value[0]));
    dxl_addparam_result = groupSyncWritePosition_->addParam(DXL_GIMBAL1_ID, (uint8_t*)&data_byte);
    if (dxl_addparam_result != true)
        return false;
    ...
    data_byte[2] = DXL_LOBYTE(DXL_HIWORD(value[1]));
    data_byte[3] = DXL_HIBYTE(DXL_HIWORD(value[1]));
    dxl_addparam_result = groupSyncWritePosition_->addParam(DXL_GIMBAL2_ID, (uint8_t*)&data_byte);
    if (dxl_addparam_result != true)
        return false;
    ...
    data_byte[2] = DXL_LOBYTE(DXL_HIWORD(value[2]));
    data_byte[3] = DXL_HIBYTE(DXL_HIWORD(value[2]));
    dxl_addparam_result = groupSyncWritePosition_->addParam(DXL_GIMBAL3_ID, (uint8_t*)&data_byte);
    if (dxl_addparam_result != true)
        return false;
    ...
    data_byte[2] = DXL_LOBYTE(DXL_HIWORD(value[3]));
    data_byte[3] = DXL_HIBYTE(DXL_HIWORD(value[3]));
    dxl_addparam_result = groupSyncWritePosition_->addParam(DXL_GIMBAL4_ID, (uint8_t*)&data_byte);
    if (dxl_addparam_result != true)
        return false;
